...
OBJECTS += src/main.o src/retarget.o src/v7.o src/sj_prompt.o src/audio.o src/gpio.o src/gsm.o src/lcd_sitronix_st7789s.o src/tp_goodix_gt9xx.o src/tp_i2c.o

WORKSPACE_PATH = ./
GCC_BIN = ../RePhone_with_CodeLite/LINKIT_ASSIST_SDK/tools/gcc-arm-none-eabi-4_9-2014q4-20141203-win32/bin/
